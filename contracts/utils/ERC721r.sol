...
import "@openzeppelin/contracts-v48/token/ERC721/IERC721.sol";
import "@openzeppelin/contracts-v48/token/ERC721/IERC721Receiver.sol";
import "@openzeppelin/contracts-v48/token/ERC721/extensions/IERC721Metadata.sol";
import "@openzeppelin/contracts-v48/utils/Address.sol";
import "@openzeppelin/contracts-v48/utils/Context.sol";
import "@openzeppelin/contracts-v48/utils/Strings.sol";
import "@openzeppelin/contracts-v48/utils/introspection/ERC165.sol";
import "@chainlink/contracts-dev/src/v0.8/vrf/dev/interfaces/IVRFCoordinatorV2Plus.sol";
...
//   }
    ...
    function rawFulfillRandomWords(uint256 _requestId, uint256[] memory randomWords) external {
